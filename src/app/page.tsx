...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#1a1a1a]">
      ...
      {/* Announcement Bar */}
      <div className="bg-[#FFE600] text-[#1a1a1a] py-2.5 px-4 text-center">
      ...
      <section className="relative overflow-hidden border-b border-gray-200">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 right-0 w-[700px] h-[700px] rounded-full bg-[#FFE600]/15 blur-[140px] translate-x-1/3 -translate-y-1/4" />
          <div className="absolute bottom-0 left-0 w-[500px] h-[500px] rounded-full bg-[#FFE600]/10 blur-[120px] -translate-x-1/4 translate-y-1/4" />
        </div>
      ...
      <div className="bg-[#FFE600] py-3 overflow-hidden">
        <div className="animate-marquee inline-block text-[#1a1a1a] font-black uppercase text-sm tracking-widest">
      ...
      {/* Categories */}
      <section className="border-b border-gray-200 py-16 md:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {CATEGORIES.map((cat, i) => (
              <div
                key={i}
                className="flex items-center gap-4 p-5 bg-white border border-gray-200 rounded-[4px] hover:border-[#FFE600] hover:shadow-md transition-all cursor-pointer group"
              >
      ...
      {/* Why Us */}
      <section className="border-b border-gray-200 py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={i}
                  className="p-5 bg-gray-50 border border-gray-200 rounded-[4px]"
                >
      ...
      <section className="py-20 md:py-28 relative overflow-hidden bg-gray-50">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute inset-0 bg-[#FFE600]/10" />
        </div>
